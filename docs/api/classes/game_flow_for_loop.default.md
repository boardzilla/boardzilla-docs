[boardzilla](../index.md) / [Modules](../modules.md) / [game/flow/for-loop](../modules/game_flow_for_loop.md) / default
...
- [setPositionFromJSON](game_flow_for_loop.default.md#setpositionfromjson)
