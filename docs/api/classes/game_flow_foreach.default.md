[boardzilla](../index.md) / [Modules](../modules.md) / [game/flow/foreach](../modules/game_flow_foreach.md) / default
...
[game/flow/foreach.ts:11](https://github.com/aghull/boardzilla-core/blob/1935b1b/game/flow/foreach.ts#L11)
